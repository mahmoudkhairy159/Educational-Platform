...
//Register page
    ...
    'Address' =>'العنوان',
    'Phone' =>'رقم الهاتف',
    'Confirm Password' =>'أعد كتابة الرقم السري',
//Login page
    'Login' => 'تسجيل الدخول',
    'E-Mail'=>'الإيميل',
    'Password'=>'الرقم السري',
    'Remember Me'=> 'تذكرني',
    'Forgot Your Password?'=> 'هل نسيت الرقم السري؟',
    ...
    //cart page
    'Have coupon?'=>'هل لديك خصم؟',
    'Coupon code'=>'كود الخصم',
    'Total Price'=>'السعر الكلي',
    'Discount'=>'الخصم',
    'Total'=>'السعر بعد الخصم',
    'Make a Purchase'=>'أتمم عملية الشراء',
...
//create product
    ...
    'Re-enter New Password'=>'اعد كتابة الرقم السري الجديد',
    'Show CartList'=>'اعرض سلة المشتريات',
    'Show Orders'=>'اعرض الطلباات',
    'Order ID'=>'رقم الطلب',
    'Order Status'=>'حالة الطلب',
    'Payment Method'=>'طريقة الدفع',
    'Payment Status'=>'حالة الدفع',
    'Choose Payment Method'=>'اختار وسيلة الدفع',
    'Cash'=>'نقدا',
    'VISA'=>'بالفيزا',
