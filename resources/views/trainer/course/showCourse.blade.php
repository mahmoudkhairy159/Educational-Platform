...
<main id="main" class="main pb-1 mb-1">
    ...
    <div class="row justify-content-center align-items-center ">
        <a href="{{  route('courses.showCourseEnrollmentRequests',['courseId'=>$course->id])}}" class="btn btn-primary rounded-3 border-secondary col-auto">{{__('messages.Show Enrollment Requests')}}  <i class="fa-solid fs-4 fa-computer-mouse"></i></a>
    </div>
            ...
            <div class=" col-xl-5 card">
                <div class="card-body course-card pt-4 d-flex flex-column align-items-center ">
                    <div class="main_image">
                        <img src="{{asset('storage/images/courses/'.$course->photo)}}" id="main_course_image"
                            width="350">
                    </div>
                ...
                <div class="card-body pt-3 ">
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active course-overview" id="course-overview">
                            ...
                            <div class="row">
                                <div class="col-5 ">
                                    <h6>{{__('messages.English Name')}}</h6>
                                </div>
                                <div class="col-7">
                                    <p>{{$course->name_en}}</p>
                                </div>
                            ...
                            <a href="{{  route('courses.showCourseStudents',['courseId'=>$course->id])}}" class="btn btn-secondary ">{{__('messages.Show Students')}} <i class="fa-solid fs-5 fa-arrow-right"></i> </a>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade course-edit pt-3" id="course-edit">
                            ...
                            <form method="POST" action="{{route('courses.update',[$course->id])}}"
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-4 col-form-label">{{__('messages.Arabic
                                        Name')}}</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="name_ar"
                                            value="{{$course->name_ar}}">
                                    </div>
                                    <label for="inputText" class="col-sm-4 col-form-label">{{__('messages.English
                                        Name')}}</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row mb-3">
                                    <label for="inputPassword" class="col-sm-4 col-form-label">{{__('messages.Arabic
                                        Description')}}</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row mb-3">
                                    <label for="inputPassword" class="col-sm-4 col-form-label">{{__('messages.English
                                        Description')}}</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <button type="submit" class="btn btn-success col-4">{{__('messages.Edit Course')}}
