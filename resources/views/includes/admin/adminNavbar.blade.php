...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar row" >
        <form class="search-form  d-flex align-items-center" method="POST" action={{route('searchForProduct')}}>
            ...
            <input type="text" name="searchValue" placeholder="{{__('messages.Search')}}" title="Enter search keyword" required>
            <button type="submit" title="Search"><i class="bi bi-search"></i></button>
            </div>
            <div class="col-md-4">
            <select class="form-select" aria-label="Default select example" name="searchType" required>
                <option selected value="id">{{__('messages.ID')}}</option>
                <option value="name_en">{{__('messages.Name')}}</option>
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{route('admins.show',Auth::id())}}">
